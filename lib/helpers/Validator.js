...
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.validatePlace = function (x, y, table) {
        if (x > table.size) {
            return {
        ...
        if (x < table.originX) {
            return {
                message: "x : " + x + " " + ValidationErrorObject_1.ValidationErrorObject.mustBeGreaterThanOrigin
            };
        }
        if (y > table.size) {
            return {
        ...
        if (y < table.originY) {
            return {
                message: "y : " + y + " " + ValidationErrorObject_1.ValidationErrorObject.mustBeGreaterThanOrigin
            };
        }
        return {};
    };
