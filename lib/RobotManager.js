...
var RobotManager = /** @class */ (function () {
     ...
     * createRobot
     */
    RobotManager.prototype.createRobot = function (tableSize, x, y, face) {
        ...
        var validatePlaceError = validator.validatePlace(x, y, tableSize); // todo throw exception instead of returning error obj
        if (Object.keys(validatePlaceError).length > 0) {
            console.log(validatePlaceError.message);
            return;
        }
        var table = { size: tableSize };
